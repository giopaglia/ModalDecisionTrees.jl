...
decision1 = ExistentialScalarDecision(global_rel, UnivariateMin(1), >=, 10)
decision2 = ExistentialScalarDecision(IA_A, UnivariateMin(2), <, 0)
decision3 = ExistentialScalarDecision(IA_L, UnivariateMin(3), <=, 0)
