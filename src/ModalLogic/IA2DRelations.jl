...
# Defined as combination of Interval Algebra, RelationId & RelationGlob
const _IABase = Union{_IARel,_RelationId,_RelationGlob}
...
# Interval Algebra relations
                                                   const IA_IU  = _IA2DRel(RelationId  , RelationGlob); const IA_IA  = _IA2DRel(RelationId  , IA_A); const IA_IL  = _IA2DRel(RelationId  , IA_L); const IA_IB  = _IA2DRel(RelationId  , IA_B); const IA_IE  = _IA2DRel(RelationId  , IA_E); const IA_ID  = _IA2DRel(RelationId  , IA_D); const IA_IO  = _IA2DRel(RelationId  , IA_O); const IA_IAi  = _IA2DRel(RelationId  , IA_Ai); const IA_ILi  = _IA2DRel(RelationId  , IA_Li); const IA_IBi  = _IA2DRel(RelationId  , IA_Bi); const IA_IEi  = _IA2DRel(RelationId  , IA_Ei); const IA_IDi  = _IA2DRel(RelationId  , IA_Di); const IA_IOi  = _IA2DRel(RelationId  , IA_Oi);
const IA_UI  = _IA2DRel(RelationGlob , RelationId);                                                     const IA_UA  = _IA2DRel(RelationGlob , IA_A); const IA_UL  = _IA2DRel(RelationGlob , IA_L); const IA_UB  = _IA2DRel(RelationGlob , IA_B); const IA_UE  = _IA2DRel(RelationGlob , IA_E); const IA_UD  = _IA2DRel(RelationGlob , IA_D); const IA_UO  = _IA2DRel(RelationGlob , IA_O); const IA_UAi  = _IA2DRel(RelationGlob , IA_Ai); const IA_ULi  = _IA2DRel(RelationGlob , IA_Li); const IA_UBi  = _IA2DRel(RelationGlob , IA_Bi); const IA_UEi  = _IA2DRel(RelationGlob , IA_Ei); const IA_UDi  = _IA2DRel(RelationGlob , IA_Di); const IA_UOi  = _IA2DRel(RelationGlob , IA_Oi);
const IA_AI  = _IA2DRel(IA_A        , RelationId); const IA_AU  = _IA2DRel(IA_A        , RelationGlob); const IA_AA  = _IA2DRel(IA_A        , IA_A); const IA_AL  = _IA2DRel(IA_A        , IA_L); const IA_AB  = _IA2DRel(IA_A        , IA_B); const IA_AE  = _IA2DRel(IA_A        , IA_E); const IA_AD  = _IA2DRel(IA_A        , IA_D); const IA_AO  = _IA2DRel(IA_A        , IA_O); const IA_AAi  = _IA2DRel(IA_A        , IA_Ai); const IA_ALi  = _IA2DRel(IA_A        , IA_Li); const IA_ABi  = _IA2DRel(IA_A        , IA_Bi); const IA_AEi  = _IA2DRel(IA_A        , IA_Ei); const IA_ADi  = _IA2DRel(IA_A        , IA_Di); const IA_AOi  = _IA2DRel(IA_A        , IA_Oi);
const IA_LI  = _IA2DRel(IA_L        , RelationId); const IA_LU  = _IA2DRel(IA_L        , RelationGlob); const IA_LA  = _IA2DRel(IA_L        , IA_A); const IA_LL  = _IA2DRel(IA_L        , IA_L); const IA_LB  = _IA2DRel(IA_L        , IA_B); const IA_LE  = _IA2DRel(IA_L        , IA_E); const IA_LD  = _IA2DRel(IA_L        , IA_D); const IA_LO  = _IA2DRel(IA_L        , IA_O); const IA_LAi  = _IA2DRel(IA_L        , IA_Ai); const IA_LLi  = _IA2DRel(IA_L        , IA_Li); const IA_LBi  = _IA2DRel(IA_L        , IA_Bi); const IA_LEi  = _IA2DRel(IA_L        , IA_Ei); const IA_LDi  = _IA2DRel(IA_L        , IA_Di); const IA_LOi  = _IA2DRel(IA_L        , IA_Oi);
const IA_BI  = _IA2DRel(IA_B        , RelationId); const IA_BU  = _IA2DRel(IA_B        , RelationGlob); const IA_BA  = _IA2DRel(IA_B        , IA_A); const IA_BL  = _IA2DRel(IA_B        , IA_L); const IA_BB  = _IA2DRel(IA_B        , IA_B); const IA_BE  = _IA2DRel(IA_B        , IA_E); const IA_BD  = _IA2DRel(IA_B        , IA_D); const IA_BO  = _IA2DRel(IA_B        , IA_O); const IA_BAi  = _IA2DRel(IA_B        , IA_Ai); const IA_BLi  = _IA2DRel(IA_B        , IA_Li); const IA_BBi  = _IA2DRel(IA_B        , IA_Bi); const IA_BEi  = _IA2DRel(IA_B        , IA_Ei); const IA_BDi  = _IA2DRel(IA_B        , IA_Di); const IA_BOi  = _IA2DRel(IA_B        , IA_Oi);
const IA_EI  = _IA2DRel(IA_E        , RelationId); const IA_EU  = _IA2DRel(IA_E        , RelationGlob); const IA_EA  = _IA2DRel(IA_E        , IA_A); const IA_EL  = _IA2DRel(IA_E        , IA_L); const IA_EB  = _IA2DRel(IA_E        , IA_B); const IA_EE  = _IA2DRel(IA_E        , IA_E); const IA_ED  = _IA2DRel(IA_E        , IA_D); const IA_EO  = _IA2DRel(IA_E        , IA_O); const IA_EAi  = _IA2DRel(IA_E        , IA_Ai); const IA_ELi  = _IA2DRel(IA_E        , IA_Li); const IA_EBi  = _IA2DRel(IA_E        , IA_Bi); const IA_EEi  = _IA2DRel(IA_E        , IA_Ei); const IA_EDi  = _IA2DRel(IA_E        , IA_Di); const IA_EOi  = _IA2DRel(IA_E        , IA_Oi);
const IA_DI  = _IA2DRel(IA_D        , RelationId); const IA_DU  = _IA2DRel(IA_D        , RelationGlob); const IA_DA  = _IA2DRel(IA_D        , IA_A); const IA_DL  = _IA2DRel(IA_D        , IA_L); const IA_DB  = _IA2DRel(IA_D        , IA_B); const IA_DE  = _IA2DRel(IA_D        , IA_E); const IA_DD  = _IA2DRel(IA_D        , IA_D); const IA_DO  = _IA2DRel(IA_D        , IA_O); const IA_DAi  = _IA2DRel(IA_D        , IA_Ai); const IA_DLi  = _IA2DRel(IA_D        , IA_Li); const IA_DBi  = _IA2DRel(IA_D        , IA_Bi); const IA_DEi  = _IA2DRel(IA_D        , IA_Ei); const IA_DDi  = _IA2DRel(IA_D        , IA_Di); const IA_DOi  = _IA2DRel(IA_D        , IA_Oi);
const IA_OI  = _IA2DRel(IA_O        , RelationId); const IA_OU  = _IA2DRel(IA_O        , RelationGlob); const IA_OA  = _IA2DRel(IA_O        , IA_A); const IA_OL  = _IA2DRel(IA_O        , IA_L); const IA_OB  = _IA2DRel(IA_O        , IA_B); const IA_OE  = _IA2DRel(IA_O        , IA_E); const IA_OD  = _IA2DRel(IA_O        , IA_D); const IA_OO  = _IA2DRel(IA_O        , IA_O); const IA_OAi  = _IA2DRel(IA_O        , IA_Ai); const IA_OLi  = _IA2DRel(IA_O        , IA_Li); const IA_OBi  = _IA2DRel(IA_O        , IA_Bi); const IA_OEi  = _IA2DRel(IA_O        , IA_Ei); const IA_ODi  = _IA2DRel(IA_O        , IA_Di); const IA_OOi  = _IA2DRel(IA_O        , IA_Oi);
const IA_AiI = _IA2DRel(IA_Ai       , RelationId); const IA_AiU = _IA2DRel(IA_Ai       , RelationGlob); const IA_AiA = _IA2DRel(IA_Ai       , IA_A); const IA_AiL = _IA2DRel(IA_Ai       , IA_L); const IA_AiB = _IA2DRel(IA_Ai       , IA_B); const IA_AiE = _IA2DRel(IA_Ai       , IA_E); const IA_AiD = _IA2DRel(IA_Ai       , IA_D); const IA_AiO = _IA2DRel(IA_Ai       , IA_O); const IA_AiAi = _IA2DRel(IA_Ai       , IA_Ai); const IA_AiLi = _IA2DRel(IA_Ai       , IA_Li); const IA_AiBi = _IA2DRel(IA_Ai       , IA_Bi); const IA_AiEi = _IA2DRel(IA_Ai       , IA_Ei); const IA_AiDi = _IA2DRel(IA_Ai       , IA_Di); const IA_AiOi = _IA2DRel(IA_Ai       , IA_Oi);
const IA_LiI = _IA2DRel(IA_Li       , RelationId); const IA_LiU = _IA2DRel(IA_Li       , RelationGlob); const IA_LiA = _IA2DRel(IA_Li       , IA_A); const IA_LiL = _IA2DRel(IA_Li       , IA_L); const IA_LiB = _IA2DRel(IA_Li       , IA_B); const IA_LiE = _IA2DRel(IA_Li       , IA_E); const IA_LiD = _IA2DRel(IA_Li       , IA_D); const IA_LiO = _IA2DRel(IA_Li       , IA_O); const IA_LiAi = _IA2DRel(IA_Li       , IA_Ai); const IA_LiLi = _IA2DRel(IA_Li       , IA_Li); const IA_LiBi = _IA2DRel(IA_Li       , IA_Bi); const IA_LiEi = _IA2DRel(IA_Li       , IA_Ei); const IA_LiDi = _IA2DRel(IA_Li       , IA_Di); const IA_LiOi = _IA2DRel(IA_Li       , IA_Oi);
const IA_BiI = _IA2DRel(IA_Bi       , RelationId); const IA_BiU = _IA2DRel(IA_Bi       , RelationGlob); const IA_BiA = _IA2DRel(IA_Bi       , IA_A); const IA_BiL = _IA2DRel(IA_Bi       , IA_L); const IA_BiB = _IA2DRel(IA_Bi       , IA_B); const IA_BiE = _IA2DRel(IA_Bi       , IA_E); const IA_BiD = _IA2DRel(IA_Bi       , IA_D); const IA_BiO = _IA2DRel(IA_Bi       , IA_O); const IA_BiAi = _IA2DRel(IA_Bi       , IA_Ai); const IA_BiLi = _IA2DRel(IA_Bi       , IA_Li); const IA_BiBi = _IA2DRel(IA_Bi       , IA_Bi); const IA_BiEi = _IA2DRel(IA_Bi       , IA_Ei); const IA_BiDi = _IA2DRel(IA_Bi       , IA_Di); const IA_BiOi = _IA2DRel(IA_Bi       , IA_Oi);
const IA_EiI = _IA2DRel(IA_Ei       , RelationId); const IA_EiU = _IA2DRel(IA_Ei       , RelationGlob); const IA_EiA = _IA2DRel(IA_Ei       , IA_A); const IA_EiL = _IA2DRel(IA_Ei       , IA_L); const IA_EiB = _IA2DRel(IA_Ei       , IA_B); const IA_EiE = _IA2DRel(IA_Ei       , IA_E); const IA_EiD = _IA2DRel(IA_Ei       , IA_D); const IA_EiO = _IA2DRel(IA_Ei       , IA_O); const IA_EiAi = _IA2DRel(IA_Ei       , IA_Ai); const IA_EiLi = _IA2DRel(IA_Ei       , IA_Li); const IA_EiBi = _IA2DRel(IA_Ei       , IA_Bi); const IA_EiEi = _IA2DRel(IA_Ei       , IA_Ei); const IA_EiDi = _IA2DRel(IA_Ei       , IA_Di); const IA_EiOi = _IA2DRel(IA_Ei       , IA_Oi);
const IA_DiI = _IA2DRel(IA_Di       , RelationId); const IA_DiU = _IA2DRel(IA_Di       , RelationGlob); const IA_DiA = _IA2DRel(IA_Di       , IA_A); const IA_DiL = _IA2DRel(IA_Di       , IA_L); const IA_DiB = _IA2DRel(IA_Di       , IA_B); const IA_DiE = _IA2DRel(IA_Di       , IA_E); const IA_DiD = _IA2DRel(IA_Di       , IA_D); const IA_DiO = _IA2DRel(IA_Di       , IA_O); const IA_DiAi = _IA2DRel(IA_Di       , IA_Ai); const IA_DiLi = _IA2DRel(IA_Di       , IA_Li); const IA_DiBi = _IA2DRel(IA_Di       , IA_Bi); const IA_DiEi = _IA2DRel(IA_Di       , IA_Ei); const IA_DiDi = _IA2DRel(IA_Di       , IA_Di); const IA_DiOi = _IA2DRel(IA_Di       , IA_Oi);
...
# 2*13=26 const _IA2DRelations_U =
	# Union{_IA2DRel{_RelationGlob,_RelationId},_IA2DRel{_RelationGlob,_IA_A},_IA2DRel{_RelationGlob,_IA_L},_IA2DRel{_RelationGlob,_IA_B},_IA2DRel{_RelationGlob,_IA_E},_IA2DRel{_RelationGlob,_IA_D},_IA2DRel{_RelationGlob,_IA_O},_IA2DRel{_RelationGlob,_IA_Ai},_IA2DRel{_RelationGlob,_IA_Li},_IA2DRel{_RelationGlob,_IA_Bi},_IA2DRel{_RelationGlob,_IA_Ei},_IA2DRel{_RelationGlob,_IA_Di},_IA2DRel{_RelationGlob,_IA_Oi},
				# _IA2DRel{_RelationId,_RelationGlob},_IA2DRel{_IA_A,_RelationGlob},_IA2DRel{_IA_L,_RelationGlob},_IA2DRel{_IA_B,_RelationGlob},_IA2DRel{_IA_E,_RelationGlob},_IA2DRel{_IA_D,_RelationGlob},_IA2DRel{_IA_O,_RelationGlob},_IA2DRel{_IA_Ai,_IA_Ai},_IA2DRel{_IA_Li,_IA_Li},_IA2DRel{_IA_Bi,_IA_Bi},_IA2DRel{_IA_Ei,_IA_Ei},_IA2DRel{_IA_Di,_IA_Di},_IA2DRel{_IA_Oi,_IA_Oi}}
