...
function accessibles(w::WorldType, r::Relation, args...) where {WorldType<:World}
...
function accessibles(S::AbstractWorldSet{WorldType}, r::Relation, args...) where {WorldType<:World}
...
function Base.show(io::IO, o::Ontology{WT}) where {WT<:World}
