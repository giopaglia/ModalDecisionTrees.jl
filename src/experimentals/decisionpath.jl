...
function _get_path_in_tree(tree::DTInternal, X::MultiFrameLogiset, i_instance::Integer, worlds::AbstractVector{<:AbstractWorldSet}, frameid::Integer, paths::Vector{DecisionPath})::AbstractWorldSet
    satisfied = true
